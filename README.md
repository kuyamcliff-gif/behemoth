...
- **Never claims something works without testing it.** Asks for test credentials and verifies signup, signin, payments, and admin flows end to end. Runs a full security audit (the kind that catches the vulnerabilities 40% of AI code ships with) before anything deploys.
...
└── references/
    ...
    ├── security.md             the pre-deploy audit checklist
